var _w = $(window),
	...
	_this = $('.cycle-slide>img'),
	_thisParent = $('.cycle-slide'),
	img = new Image(),
...
img.src = $('.cycle-slide>img').attr('src');
img.onload = function() {
	// 当图片加载完成时获取图片的原图大小
...
$('.next-button').click(function(){
	_this = $('.cycle-slide-active');
	_this.animate({
		"opacity":"0",
		"display":"none"
	});
	_this.removeClass('cycle-slide-active');
	_this.next().addClass('cycle-slide-active');
	_this.next().animate({
		"display":"block",
		"opacity":"1"
	});
